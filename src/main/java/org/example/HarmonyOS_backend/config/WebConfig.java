...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(loginCheckInterceptor).addPathPatterns("/api/image/imageUpload","/api/userLike/changeUserLike",
                ...
                "/api/image/deleteImage","/api/bookmark/changeBookmark","/api/bookmark/getBookmarkList").excludePathPatterns("/api/user/login","/api/user/register","/api/email/sendVerificationCode");
    }
