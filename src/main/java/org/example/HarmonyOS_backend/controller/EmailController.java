...
import org.example.HarmonyOS_backend.model.dto.VerifyCodeDto;
...
public class EmailController {
    ...
    public Result<T> verifyCode(@RequestBody VerifyCodeDto verifyCodeDto)
    {
        return emailService.verifyCode(verifyCodeDto.getEmail(), verifyCodeDto.getCode());
    }
}
